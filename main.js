...
function my_keydown(e)
{
	...
	document.getElementById("hd3").innerHTML="Você acertou o boraco!!!"
	...
	function up()
	{
		...
		console.log("cima"+ block_image_height);
	...
	function down()
	{
		 ...
		 if(ball_y<=450)
		 {ball_y = ball_y + block_image_height;
		 console.log("baixo"+ block_image_height);
	...
	function left()
	{
		if(ball_x >5)
		{
			...
			if(ball_y<=450)
			{ball_y = ball_y + block_image_height;
			console.log("esquerda"+ block_image_height);
	...
	function right()
	{
		if(ball_x <=1050)
		{
			if(ball_y<=450)
			{ball_y = ball_y + block_image_height;
			console.log("direita"+ block_image_height);
			console.log("Quando a seta para direita é pressionada, X= "+ ball_x +", Y= "+ball_y)
			canvas.remove(ball_obj);
			new_image();	// Programe o movimento da bola para a direita.
		}
	}
